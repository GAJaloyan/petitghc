...
./petitghc -o ___tmp___.s tests/exec-fail/bool1.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/division_by_zero.hs" 
./petitghc -o ___tmp___.s tests/exec-fail/division_by_zero.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/error1.hs"
./petitghc -o ___tmp___.s tests/exec-fail/error1.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/error2.hs" 
./petitghc -o ___tmp___.s tests/exec-fail/error2.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/error3.hs"
./petitghc -o ___tmp___.s tests/exec-fail/error3.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/lazy1.hs"
./petitghc -o ___tmp___.s tests/exec-fail/lazy1.hs  
spim -file ___tmp___.s
echo "\ntests/exec-fail/shadowing1.hs"
./petitghc -o ___tmp___.s tests/exec-fail/shadowing1.hs
spim -file ___tmp___.s
